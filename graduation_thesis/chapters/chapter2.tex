...
\begin{enumerate}
    ...
    \item 导航坐标系$NED(north-east-down)$：原点选做无人机质心，$N$轴指向地理北极，$E$轴指向东，$D$轴符合右手定则，指向下。
    \item 航迹坐标系$O_kx_ky_kz_k$：$O_k$选为无人机质心，$O_kx_k$轴始终指向无人机地速方向，$O_kz_k$轴位于包含$O_kx_k$轴的竖直平面内，
    $o_ky_k$符合右手定则，指向右。
