...
#define CONTROL_MONITOR_INFO(a) cout << "[CONTROL_MONITOR_INFO]:" << a << endl
...
private:
  ...
  void ros_sub_pub();
  void formation_control_states_cb(
      const fixed_wing_formation_control::Formation_control_states::ConstPtr
          &msg); /*编队状态callback*/
  void fw_state_cb(const fixed_wing_formation_control::FWstates::ConstPtr
                       &msg); /*本机状态callback*/
  void leader_states_cb(const fixed_wing_formation_control::Leaderstates::ConstPtr
                       &msg); /*领机状态callback*/
  void fw_4cmd_cb(const fixed_wing_formation_control::FWcmd::ConstPtr
                      &msg); /*本机指令callback*/
